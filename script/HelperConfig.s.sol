...
contract HelperConfig is Script {
    ...
    function getSepoliaEthConfig() public view returns (NetworkConfig memory) {
        // Note: Address literals must be explicitly cast to address type in Solidity 0.8+
        return NetworkConfig({
            wethUsdPriceFeed: address(0x694AA1769357215DE4FAC081bf1f309aDC325306), // ETH / USD
